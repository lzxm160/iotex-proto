...
#	@protoc -I. --grpc-gateway_out=logtostderr=true:${GOPATH}/src ./proto/api/*
	@protoc -I. -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis --go_out=plugins=grpc:${GOPATH}/src ./proto/types/*
  	...
  	@protoc -I. -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis ./proto/rpc/*

    @protoc -I. -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis ./proto/testing/*

    @protoc -I. -I./proto/types -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis ./proto/api/*
